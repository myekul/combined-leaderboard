function generateChart() {
    google.charts.setOnLoadCallback(function () {
        sortPlayers(players)
        let normalized = document.getElementById('checkbox_chart_normalized').checked
        let fixed = document.getElementById('checkbox_chart_fixed').checked
        let maxValue = 0
        if (gameID == 'tetris') {
            hide('fixedDiv')
            fixed = false
        ...
        const options = {
            ...
            hAxis: {
                ...
                // position: 'none',
                minValue: document.getElementById('checkbox_chart_50').checked && mode != 'commBestILs' ? 50 : 0,
                maxValue: maxValue
            },
            vAxis: {
