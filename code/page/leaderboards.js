function generateLeaderboards() {
    let HTMLContent = ''
    HTMLContent += `<div class='container' style='gap:10px;margin-top:15px;${sortCategoryIndex == -1 && mode != 'commBestILs' ? 'overflow-x:scroll;justify-content:left;' : ''}align-items:flex-start'>`
