...
const difficulties = [
    ...
    { name: 'Regular Any%', className: 'regular' },
    { name: 'Regular A+', className: 'regularhighest' },
    { name: 'Expert Any%', className: 'expert' },
    { name: 'S-Rank', className: 'experthighest' },
]
const groundPlaneArray = [
    { name: 'Ground', className: 'isle1' },
    { name: 'Plane', className: 'expert' }
]
const fullgameILs = {
    '1.1+': {
        name: '1.1+',
...
const myekulSays = {
    ...
    minamikori: `See that 28:28? That was played on version 1.2. minamikori is an exceptional runner with a very unique set of skills.`,
    ...
    Sublime: `Sublime is an INSANE Legacy runner, having held the world record numerous times throughout the years. He is also an avid Hater% lover. Also, he was the first to prove Spider's Kiss was possible on Version 1.1.`
}
