...
const myekulSays = {
    ...
    Lewzr: `#1 in the UK! Lewzr is a runner who entered the scene and, within a year, managed to get a 10:XX DLC and a 27:3X 1.1+, solidifying himself as a top runner. Bro CLAWED.`,
    ...
    MarkinSws: 'MarkinSws is an UNSTOPPABLE force in current patch categories, sweeping the competition in NMG, DLC, and DLC+Base. He also holds the NMG Full Clear world record. Incredible! An inspiration for many, myself included.',
